...
<script runat="server">
  ...
  protected void UpdateUiForOverallStatus()
  {
    ...
    CreateAggregationStatusesTableHeaderRows();
    FillAggregationStatusesTableWithData(status);
  ...
  private void CreateAggregationStatusesTableHeaderRows()
  {
  ...
  private void FillAggregationStatusesTableWithData(RebuildStatus status)
  {
