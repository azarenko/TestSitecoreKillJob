  ...
  var app = sc.Definitions.App.extend({
    ...
    setupLatestEvents: function (intelBaseUrl, analyticsBaseUrl)
    {
      ...
      var fillTemplate = function (args)
      {
        ...
        cintelUtil.setText(subapp.Title, data.EventSubjectText ? data.EventSubjectText : "", true);
        ...
        cintelUtil.setText(subapp.Url, data.SiteName ? data.SiteName + " - " + data.Url : "", true);
      };
